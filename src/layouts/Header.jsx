...
const Header = () => {
  ...
  const defaultStyle = "text-color_dark";
  ...
  const styleMobile =
    "text-sm font-bold tracking-wider py-4 block text-color_white";

  return (
    <header className=" md:flex flex-col w-full justify-between items-center">
      <div className="w-full border-solid bg-[#3B3B3B] border-[#5E5E5E] border-b mx-auto">
        <div className="flex mx-auto py-3 px-4 md:max-w-[1200px] justify-between text-[#A9A9A9] md:justify md:px-6">
          <FiMenu
            color="white"
            size={24}
            onClick={handleNav}
          ...
          <div className="hidden md:block max-w-[350px] text-[#A9A9A9]">
            <ContactItem
      ...
      <nav className="hidden w-full max-w-[1200px] md:justify-between mx-auto py-6 md:flex md:items-center md:py-2 md:px-6 lg:py-5 ">
        ...
        <ul className="md:flex justify-between items-center bg-transparent">
          <li>
            <CustomLink
              to="/"
          ...
          <li className="group relative">
            ...
            <div className="invisible absolute flex w-full flex-col z-10 bg-color_light_gray group-hover:visible rounded-sm">
              <a
                ...
                className="mx-4 py-4 font-bold md:text-sm text-color_lighter_gray  hover:text-color_accent_yellow"
              >
                Гусеничный ДТ-75
              </a>
              <a
                href="/tractors/catalog-htz-t150/"
                className="mx-4 pb-4 font-bold md:text-sm text-color_lighter_gray hover:text-color_accent_yellow"
              >
                Колесный Т-150
              </a>
            </div>
