...
const organizationInfo = {
  ...
  email: "info@vzgm.ru",
  address: {
    textTop: "400006 г. Волгоград,",
    textBottom: "ул. Переяславская 3А",
  },

  address2: {
    textTop: "140152 Московская область, Раменский ",
    textBottom: "район д. Кузнецово, ул. Южная 4",
  },

  hours: {
    textTop: "Пн - Пт: 9:00 - 18:00 (МСК)",
    textBottom: "Cб - Вс: выходной",
  },
};
