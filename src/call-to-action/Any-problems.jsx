...
const AnyProblems = () => {
  return (
    <div className="relative h-[240px] md:h-[340px] max-w-[1920px] lg:mx-auto md:mb-24 mx-auto w-full">
      ...
      <div className="relative w-full h-[195px] md:h-[280px] top-[45px] md:top-[65px] bg-gradient-to-r from-color_light_gray from-50% via-40% via-color_light_gray md:from-45% lg:from-60% md:to-70%">
